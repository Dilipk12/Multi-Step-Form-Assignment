...
const Stepsecond = ({ onNext }) => {
  ...
  const data = [{ title: "Learning specific skills to advance my career", img: "/image/career.png" },
  { title: "Exploring new topics I'm interested in", img: "/image/exploring.png" },
  { title: "Refreshing my math foundations", img: "/image/refreshing.png" },
  { title: "Exercising my brain to stay sharp", img: "/image/goal.png" },
  { title: "Something else", img: "/image/eye.png" }
  ]
  ...
  return (
    <div className="flex flex-col gap-4" onClick={outsiteBtnClick}>
      ...
      <div className="flex gap-2 flex-col justify-center items-center mx-10 sm:mx-20 md:mx-0">
        {
          data.map((val, i) =>
